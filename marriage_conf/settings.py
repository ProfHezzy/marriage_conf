...
SECRET_KEY = 'django-insecure-n7wjbf_rw(il9q+nsuf_q1*olw%n=c*fy=9_n7j8ivkwjky@9h'
...
ROOT_URLCONF = 'marriage_conf.urls'
...
WSGI_APPLICATION = 'marriage_conf.wsgi.application'
